...
namespace DigiD.UITests.Pageobjects
{
    ...
    {
        private const string _title = "Instructiefilmpjes";
        private const string _waitText = "Instructiefilmpjes";
        public const string _WhatsNewTekst = "De app legt bepaalde handelingen uit in korte filmpjes, bijv. hoe u uw identiteitsbewijs scant.";
